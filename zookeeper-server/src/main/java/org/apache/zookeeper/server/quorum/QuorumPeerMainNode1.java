...
public class QuorumPeerMainNode1 {

    private static final Logger LOG = LoggerFactory.getLogger(QuorumPeerMainNode1.class);
    ...
    public static void main(String[] args) {
        QuorumPeerMainNode1 main = new QuorumPeerMainNode1();
        try {
