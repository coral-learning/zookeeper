...
public class QuorumPeerMainNode2 {

    private static final Logger LOG = LoggerFactory.getLogger(QuorumPeerMainNode2.class);
    ...
    public static void main(String[] args) {
        QuorumPeerMainNode2 main = new QuorumPeerMainNode2();
        try {
