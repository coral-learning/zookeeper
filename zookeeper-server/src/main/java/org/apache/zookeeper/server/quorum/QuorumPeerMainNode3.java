...
public class QuorumPeerMainNode3 {

    private static final Logger LOG = LoggerFactory.getLogger(QuorumPeerMainNode3.class);
    ...
    public static void main(String[] args) {
        QuorumPeerMainNode3 main = new QuorumPeerMainNode3();
        try {
